...
parser.add_argument('--data_path', type=str, default='E:\Experiment firmware\code', metavar='PATH',
                    help='data path to save files (default: E:/Experiment firmware/code)')
...
def generate_samples1(model, batch_size, generated_num, output_file):
    samples = []
    for _ in range(int(generated_num / batch_size)):
        sample = model.sample(batch_size, g_seq_len).cpu().data.numpy().tolist()
        samples.extend(sample)
    sample.extend(['22','11','333','444','5555','666','777','8','9','10','11','22','12','14','15','16','17','18','19','20'])
...
if __name__ == '__main__':
    ...
    print('#####################################################\n\n')
    #generate_samples1(target_lstm, args.batch_size, args.n_samples, POSIT777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777IVE_FILE)
    ...
    if args.rounds %10 == 0 or args.rounds == args.rounds -1:
        torch.save(generator.state_dict, args.data_path+'generatemodel.pt')
